(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('but-unzip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'but-unzip'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.adventure = {}, global.butUnzip));
})(this, (function (exports, butUnzip) { 'use strict';
  ...
  function Version(id, packageUrl) {
      ...
      const getResource = (async (path) => {
          ...
          for (const entry of butUnzip.iter(jarData)) {
  ...
  class MinecraftTranslationsImpl {
      ...
      async _getUncached(locale) {
          ...
          if (EN_US === locale) {
              ...
              if (!(key in assets))
                  throw new Error(`Locale '${locale}' not present`);
...
`);
  ...
  window.adventure.fetchTranslations = MinecraftTranslations;
  window.adventure.minecraftTranslations = MinecraftTranslations;
